...
namespace Genie.Api.Model
{
    ...
    /// PatchedAddress
    /// </summary>
    [DataContract(Name = "PatchedAddress")]
    public partial class PatchedAddress : IEquatable<PatchedAddress>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchedAddress" /> class.
        /// </summary>
        /// <param name="name">Full person name..</param>
        ...
        public PatchedAddress(string name = default(string), string email = default(string), string phone = default(string), string line1 = default(string), string line2 = default(string), string postalCode = default(string), string city = default(string), string state = default(string), CountryEnum? country = default(CountryEnum?))
        {
            this.Name = name;
            this.Email = email;
            this.Phone = phone;
        ...
        {
            return this.Equals(input as PatchedAddress);
        }

        /// <summary>
        /// Returns true if PatchedAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of PatchedAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchedAddress input)
        {
            if (input == null)
                return false;
