...
namespace Genie.Api.Api
{
    ...
    public partial class SubscriptionApi : ISubscriptionApi
    {
        ...
        /// <returns></returns>
        public SubscriptionApi(Genie.Api.Client.Configuration configuration)
        {
        ...
        public SubscriptionApi(Genie.Api.Client.ISynchronousClient client, Genie.Api.Client.IAsynchronousClient asyncClient, Genie.Api.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Genie.Api.Client.ApiResponse<NewSubscription> localVarResponse = SubscriptionCreateWithHttpInfo(newSubscription);
        ...
        /// <param name="newSubscription"></param>
        /// <returns>ApiResponse of NewSubscription</returns>
        public Genie.Api.Client.ApiResponse<NewSubscription> SubscriptionCreateWithHttpInfo(NewSubscription newSubscription)
        {
            // verify the required parameter 'newSubscription' is set
            if (newSubscription == null)
                throw new Genie.Api.Client.ApiException(400, "Missing required parameter 'newSubscription' when calling SubscriptionApi->SubscriptionCreate");
        ...
        {
            Genie.Api.Client.ApiResponse<NewSubscription> localVarResponse = await SubscriptionCreateWithHttpInfoAsync(newSubscription, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (NewSubscription)</returns>
        public async System.Threading.Tasks.Task<Genie.Api.Client.ApiResponse<NewSubscription>> SubscriptionCreateWithHttpInfoAsync(NewSubscription newSubscription, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'newSubscription' is set
            if (newSubscription == null)
                throw new Genie.Api.Client.ApiException(400, "Missing required parameter 'newSubscription' when calling SubscriptionApi->SubscriptionCreate");
        ...
        /// <exception cref="Genie.Api.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of Object(void)</returns>
        public Genie.Api.Client.ApiResponse<Object> SubscriptionDestroyWithHttpInfo()
        {
            Genie.Api.Client.RequestOptions localVarRequestOptions = new Genie.Api.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Genie.Api.Client.ApiResponse<Object>> SubscriptionDestroyWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            Genie.Api.Client.ApiResponse<Subscription> localVarResponse = SubscriptionRetrieveWithHttpInfo();
            return localVarResponse.Data;
        }
        ...
        /// <exception cref="Genie.Api.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of Subscription</returns>
        public Genie.Api.Client.ApiResponse<Subscription> SubscriptionRetrieveWithHttpInfo()
        {
            Genie.Api.Client.RequestOptions localVarRequestOptions = new Genie.Api.Client.RequestOptions();
        ...
        {
            Genie.Api.Client.ApiResponse<Subscription> localVarResponse = await SubscriptionRetrieveWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Subscription)</returns>
        public async System.Threading.Tasks.Task<Genie.Api.Client.ApiResponse<Subscription>> SubscriptionRetrieveWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
