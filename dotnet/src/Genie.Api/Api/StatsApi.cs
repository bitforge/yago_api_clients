...
namespace Genie.Api.Api
{
    ...
    public partial class StatsApi : IStatsApi
    {
        ...
        /// <returns></returns>
        public StatsApi(Genie.Api.Client.Configuration configuration)
        {
        ...
        public StatsApi(Genie.Api.Client.ISynchronousClient client, Genie.Api.Client.IAsynchronousClient asyncClient, Genie.Api.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Genie.Api.Client.ApiResponse<SummaryStats> localVarResponse = StatsGlobalCreateWithHttpInfo(globalStatistics);
        ...
        /// <param name="globalStatistics"></param>
        /// <returns>ApiResponse of SummaryStats</returns>
        public Genie.Api.Client.ApiResponse<SummaryStats> StatsGlobalCreateWithHttpInfo(GlobalStatistics globalStatistics)
        {
            // verify the required parameter 'globalStatistics' is set
            if (globalStatistics == null)
                throw new Genie.Api.Client.ApiException(400, "Missing required parameter 'globalStatistics' when calling StatsApi->StatsGlobalCreate");
        ...
        {
            Genie.Api.Client.ApiResponse<SummaryStats> localVarResponse = await StatsGlobalCreateWithHttpInfoAsync(globalStatistics, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SummaryStats)</returns>
        public async System.Threading.Tasks.Task<Genie.Api.Client.ApiResponse<SummaryStats>> StatsGlobalCreateWithHttpInfoAsync(GlobalStatistics globalStatistics, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'globalStatistics' is set
            if (globalStatistics == null)
                throw new Genie.Api.Client.ApiException(400, "Missing required parameter 'globalStatistics' when calling StatsApi->StatsGlobalCreate");
        ...
        {
            Genie.Api.Client.ApiResponse<SummaryStats> localVarResponse = StatsProjectCreateWithHttpInfo(id, projectsStatistics);
            return localVarResponse.Data;
        }
        ...
        /// <param name="projectsStatistics"></param>
        /// <returns>ApiResponse of SummaryStats</returns>
        public Genie.Api.Client.ApiResponse<SummaryStats> StatsProjectCreateWithHttpInfo(Guid id, ProjectsStatistics projectsStatistics)
        {
            // verify the required parameter 'projectsStatistics' is set
            if (projectsStatistics == null)
                throw new Genie.Api.Client.ApiException(400, "Missing required parameter 'projectsStatistics' when calling StatsApi->StatsProjectCreate");
        ...
        {
            Genie.Api.Client.ApiResponse<SummaryStats> localVarResponse = await StatsProjectCreateWithHttpInfoAsync(id, projectsStatistics, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SummaryStats)</returns>
        public async System.Threading.Tasks.Task<Genie.Api.Client.ApiResponse<SummaryStats>> StatsProjectCreateWithHttpInfoAsync(Guid id, ProjectsStatistics projectsStatistics, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'projectsStatistics' is set
            if (projectsStatistics == null)
                throw new Genie.Api.Client.ApiException(400, "Missing required parameter 'projectsStatistics' when calling StatsApi->StatsProjectCreate");
