...
namespace Genie.Api
{
    ...
    public partial class MembershipsApi : IMembershipsApi
    {
        ...
        /// <returns></returns>
        public MembershipsApi(Genie.Client.Configuration configuration)
        {
        ...
        public MembershipsApi(Genie.Client.ISynchronousClient client, Genie.Client.IAsynchronousClient asyncClient, Genie.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Genie.Client.ApiResponse<Membership> localVarResponse = MembershipsCreateWithHttpInfo(membership);
        ...
        /// <param name="membership"></param>
        /// <returns>ApiResponse of Membership</returns>
        public Genie.Client.ApiResponse<Membership> MembershipsCreateWithHttpInfo(Membership membership)
        {
            // verify the required parameter 'membership' is set
            if (membership == null)
                throw new Genie.Client.ApiException(400, "Missing required parameter 'membership' when calling MembershipsApi->MembershipsCreate");
        ...
        {
            Genie.Client.ApiResponse<Membership> localVarResponse = await MembershipsCreateWithHttpInfoAsync(membership, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Membership)</returns>
        public async System.Threading.Tasks.Task<Genie.Client.ApiResponse<Membership>> MembershipsCreateWithHttpInfoAsync(Membership membership, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'membership' is set
            if (membership == null)
                throw new Genie.Client.ApiException(400, "Missing required parameter 'membership' when calling MembershipsApi->MembershipsCreate");
        ...
        /// <param name="id">A UUID string identifying this Project member.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Genie.Client.ApiResponse<Object> MembershipsDestroyWithHttpInfo(Guid id)
        {
            Genie.Client.RequestOptions localVarRequestOptions = new Genie.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Genie.Client.ApiResponse<Object>> MembershipsDestroyWithHttpInfoAsync(Guid id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            Genie.Client.ApiResponse<List<Membership>> localVarResponse = MembershipsListWithHttpInfo(project, user);
            return localVarResponse.Data;
        }
        ...
        /// <param name="user"> (optional)</param>
        /// <returns>ApiResponse of List&lt;Membership&gt;</returns>
        public Genie.Client.ApiResponse<List<Membership>> MembershipsListWithHttpInfo(Guid? project = default(Guid?), Guid? user = default(Guid?))
        {
            Genie.Client.RequestOptions localVarRequestOptions = new Genie.Client.RequestOptions();
            ...
            if (user != null)
            {
                localVarRequestOptions.QueryParameters.Add(Genie.Client.ClientUtils.ParameterToMultiMap("", "user", user));
            }
        ...
        {
            Genie.Client.ApiResponse<List<Membership>> localVarResponse = await MembershipsListWithHttpInfoAsync(project, user, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;Membership&gt;)</returns>
        public async System.Threading.Tasks.Task<Genie.Client.ApiResponse<List<Membership>>> MembershipsListWithHttpInfoAsync(Guid? project = default(Guid?), Guid? user = default(Guid?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
