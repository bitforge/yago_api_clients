...
namespace Genie.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PatchedProjectUpdate")]
    public partial class PatchedProjectUpdate : IEquatable<PatchedProjectUpdate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchedProjectUpdate" /> class.
        /// </summary>
        /// <param name="name">Name will be visible as title in gallery..</param>
        ...
        public PatchedProjectUpdate(string name = default(string), string description = default(string), string website = default(string), bool gallery = default(bool), bool translationsDe = default(bool), bool translationsEn = default(bool), bool translationsFr = default(bool), bool translationsIt = default(bool), bool backlinkUrls = default(bool))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as PatchedProjectUpdate);
        }

        /// <summary>
        /// Returns true if PatchedProjectUpdate instances are equal
        /// </summary>
        /// <param name="input">Instance of PatchedProjectUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchedProjectUpdate input)
        {
            if (input == null)
                return false;
