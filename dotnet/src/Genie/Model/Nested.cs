...
namespace Genie.Model
{
    ...
    /// Nested
    /// </summary>
    [DataContract(Name = "Nested")]
    public partial class Nested : IEquatable<Nested>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="stripePriceId">Stripe price used to create a new subscriptions.</param>
        public Nested(string key = default(string), string name = default(string), decimal price = default(decimal), long projectQuotas = default(long), long modelQuotas = default(long), long viewQuotas = default(long), bool seoOptimization = default(bool), bool viewReporting = default(bool), bool customQrCodes = default(bool), string stripePriceId = default(string))
        {
            // to ensure "key" is required (not null)
            if (key == null) {
                throw new ArgumentNullException("key is a required property for Nested and cannot be null");
            }
            this.Key = key;
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for Nested and cannot be null");
            }
            this.Name = name;
            this.Price = price;
        ...
        /// </summary>
        /// <value>Stripe price used to create a new subscriptions</value>
        [DataMember(Name = "stripe_price_id", EmitDefaultValue = true)]
        ...
        {
            return this.Equals(input as Nested);
        }

        /// <summary>
        /// Returns true if Nested instances are equal
        /// </summary>
        /// <param name="input">Instance of Nested to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Nested input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.StripePriceId == input.StripePriceId ||
                    (this.StripePriceId != null &&
                    this.StripePriceId.Equals(input.StripePriceId))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.StripePriceId != null)
                    hashCode = hashCode * 59 + this.StripePriceId.GetHashCode();
                return hashCode;
            }
        }
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            // StripePriceId (string) maxLength
            if(this.StripePriceId != null && this.StripePriceId.Length > 255)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for StripePriceId, length must be less than 255.", new [] { "StripePriceId" });
            }
