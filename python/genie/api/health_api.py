...
class HealthApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.health_retrieve_endpoint = _Endpoint(
            settings={
    ...
    def health_retrieve(
        ...
        **kwargs
        ...
        """health_retrieve  # noqa: E501

        Check health status of required subsystems.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.health_retrieve(async_req=True)
        >>> result = thread.get()
        ...
        return self.health_retrieve_endpoint.call_with_http_info(**kwargs)
