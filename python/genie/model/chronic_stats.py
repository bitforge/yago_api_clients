...
class ChronicStats(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, label, data, total, *args, **kwargs):  # noqa: E501
        """ChronicStats - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, label, data, total, *args, **kwargs):  # noqa: E501
        """ChronicStats - a model defined in OpenAPI
