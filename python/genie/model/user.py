...
class User(ModelNormal):
    ...
    def _from_openapi_data(cls, id, email, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            is_active (bool): Deactivated users cannot login.. [optional]  # noqa: E501
            is_staff (bool): Allow login to Genie AR CMS. Can be disabled for API users.. [optional]  # noqa: E501
            is_superuser (bool): User can see and change anything. Only for Bitforge employees.. [optional]  # noqa: E501
        """
