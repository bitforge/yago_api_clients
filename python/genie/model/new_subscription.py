...
class NewSubscription(ModelNormal):
    ...
    attribute_map = {
        ...
        'tos_accepted': 'tos_accepted',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, plan, payment_method, tos_accepted, customer_id, subscription_id, client_secret, *args, **kwargs):  # noqa: E501
        """NewSubscription - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, plan, payment_method, tos_accepted, *args, **kwargs):  # noqa: E501
        """NewSubscription - a model defined in OpenAPI
