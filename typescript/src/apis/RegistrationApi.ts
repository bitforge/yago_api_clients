...
export class RegistrationApi extends runtime.BaseAPI {
    ...
    async registrationCreateRaw(
        ...
        if (requestParameters.registrationCreate === null || requestParameters.registrationCreate === undefined) {
            throw new runtime.RequiredError(
                'registrationCreate',
                'Required parameter requestParameters.registrationCreate was null or undefined when calling registrationCreate.'
            );
        }
    ...
    async registrationVerifyCreateRaw(
        ...
        if (requestParameters.code === null || requestParameters.code === undefined) {
            throw new runtime.RequiredError(
                'code',
                'Required parameter requestParameters.code was null or undefined when calling registrationVerifyCreate.'
            );
        }
        ...
        const response = await this.request(
            {
                path: `/api/registration/verify/{code}/`.replace(
                    `{${'code'}}`,
