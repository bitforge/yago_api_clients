...
public struct VideoDetail: Codable, JSONEncodable, Hashable {
    ...
    public init(id: UUID, title: String, video: String, thumb: String, thumbSmall: String, thumbMedium: String, thumbLarge: String, description: String? = nil, language: LanguageEnum? = nil, uploadedBy: UUID, authorName: String? = nil, authorEmail: String? = nil, recordDate: Date? = nil, location: String? = nil, geoLat: Decimal? = nil, geoLng: Decimal? = nil, metaData: [String: AnyCodable]? = nil, links: [VideoLink], tags: String? = nil, videoMeta: [String: AnyCodable], created: Date, modified: Date) {
        self.id = id
        self.title = title
        self.video = video
        self.thumb = thumb
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(videoMeta, forKey: .videoMeta)
