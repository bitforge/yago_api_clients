...
public class AuthApi {
    ...
    /**
     * Build call for authPasswordChangeCreate
     ...
     */
    public okhttp3.Call authPasswordChangeCreateCall(PasswordChange passwordChange, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        ...
        // create path and map variables
        String localVarPath = "/api/auth/password/change/";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call authPasswordChangeCreateValidateBeforeCall(PasswordChange passwordChange, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'passwordChange' is set
        if (passwordChange == null) {
            throw new ApiException("Missing the required parameter 'passwordChange' when calling authPasswordChangeCreate(Async)");
        }
        

        okhttp3.Call localVarCall = authPasswordChangeCreateCall(passwordChange, _callback);
        return localVarCall;
     ...
     */
    public PasswordChange authPasswordChangeCreate(PasswordChange passwordChange) throws ApiException {
        ApiResponse<PasswordChange> localVarResp = authPasswordChangeCreateWithHttpInfo(passwordChange);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PasswordChange> authPasswordChangeCreateWithHttpInfo(PasswordChange passwordChange) throws ApiException {
        okhttp3.Call localVarCall = authPasswordChangeCreateValidateBeforeCall(passwordChange, null);
     ...
     */
    public okhttp3.Call authPasswordChangeCreateAsync(PasswordChange passwordChange, final ApiCallback<PasswordChange> _callback) throws ApiException {

        okhttp3.Call localVarCall = authPasswordChangeCreateValidateBeforeCall(passwordChange, _callback);
        Type localVarReturnType = new TypeToken<PasswordChange>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
