...
class CustomerApi {
  ...
  Future<Response<Address>> customerBillingAddressPartialUpdate({
    ...
    final _path = r'/api/customer/billing_address/';
    ...
    try {
      _bodyData = jsonEncode(patchedAddress);
  ...
  /// Returns a [Future] containing a [Response] with a [Address] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Address>> customerBillingAddressRetrieve({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [Address] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Address>> customerBillingAddressUpdate({
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Customer>> customerRetrieve({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
