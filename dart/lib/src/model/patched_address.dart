...
class PatchedAddress {
  ...
  factory PatchedAddress.fromJson(Map<String, dynamic> json) => _$PatchedAddressFromJson(json);

  Map<String, dynamic> toJson() => _$PatchedAddressToJson(this);
