...
part of 'order_model_create.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

OrderModelCreate _$OrderModelCreateFromJson(Map<String, dynamic> json) =>
    $checkedCreate(
      'OrderModelCreate',
      json,
      ($checkedConvert) {
...
Map<String, dynamic> _$OrderModelCreateToJson(OrderModelCreate instance) {
