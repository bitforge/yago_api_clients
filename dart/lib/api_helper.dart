...
String parameterToString(dynamic value) {
  ...
  if (value is CollectionMethodEnum) {
    return CollectionMethodEnumTypeTransformer().encode(value).toString();
  }
  if (value is CountryEnum) {
    return CountryEnumTypeTransformer().encode(value).toString();
  }
  if (value is FilterEventsEnum) {
    return FilterEventsEnumTypeTransformer().encode(value).toString();
  }
  if (value is GlobalStatisticsGroupByEnum) {
    return GlobalStatisticsGroupByEnumTypeTransformer().encode(value).toString();
  }
  ...
  if (value is StripeSubscriptionStatusEnum) {
    return StripeSubscriptionStatusEnumTypeTransformer().encode(value).toString();
  }
  if (value is TimeRangeEnum) {
    return TimeRangeEnumTypeTransformer().encode(value).toString();
  }
