...
class ProjectUpdate {
  ...
  static List<ProjectUpdate> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(ProjectUpdate.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <ProjectUpdate>[];
  ...
  static Map<String, ProjectUpdate> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = ProjectUpdate.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of ProjectUpdate-objects as value to a dart map
  static Map<String, List<ProjectUpdate>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<ProjectUpdate>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = ProjectUpdate.listFromJson(
            value,
