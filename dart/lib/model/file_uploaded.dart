...
class FileUploaded {
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "FileUploaded[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "FileUploaded[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<FileUploaded> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = FileUploaded.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, FileUploaded> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value = FileUploaded.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<FileUploaded>> mapListFromJson(
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = FileUploaded.listFromJson(
          entry.value,
          growable: growable,
        );
      }
